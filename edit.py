...
class CustomTkinter:
    def __init__(self, master):
        ...
        self.master.configure(bg="#B29F9F")
        ...
        self.master.config(bg="#B29F9F")

        self.heading_label = tk.Label(self.master, text="Welcome to Employees Vault", bg='#B29F9F',
                                      font=("Helvetica", 18, "bold"))
        self.heading_label.pack()

        self.add_employee_label = tk.Label(self.master, text="EditEmployee", bg='#B29F9F',
        ...
        self.enter_button = tk.Button(self.master, text="ENTER", font=("Helvetica", 10, "bold"),
                                      command=self.update_employee_details, width=20, height=1, bg="purple", fg="white")
        self.enter_button.place(x=500, y=665)


        self.delete_button = tk.Button(self.master, text="delete", font=("Helvetica", 10, "bold"), command=self.delete_employee,
                                     width=20, height=1, bg="red", fg="white")
        self.delete_button.place(x=850, y=100)



        self.back_button = tk.Button(self.master, text="Back", font=("Helvetica", 10, "bold"), command=self.acer_win,
                                     width=20, height=1, bg="red", fg="white")
    ...
    def update_employee_details(self):
        ...
        try:
            ...
            msg['From'] = 'employeevault69@gmail.com'  # Change to your email address
            ...
            with smtplib.SMTP_SSL('smtp.gmail.com', 465) as smtp:
                smtp.login('employeevault69@gmail.com', 'vwnf sbsk foxo xhec')  # Replace with your email credentials
...
# Define __del__ method outside the class
